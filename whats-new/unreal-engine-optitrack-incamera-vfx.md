---
cover: ../.gitbook/assets/PageBanner_Mandolorian.png
coverY: 0
---
...
![Cabling diagram.](<../.gitbook/assets/image (1067).png>)
...
| ------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------- |
| <img src="../.gitbook/assets/IMU_Status1.png" alt="" data-size="original">                                                                 | <img src="../.gitbook/assets/IMU_Status2.png" alt="" data-size="original">                                                           | <img src="../.gitbook/assets/IMU_Status3.png" alt="" data-size="original">                                                                                                                                                                  | Viewport    |
...
![Immersive scene with InCamera VFX.](<../.gitbook/assets/Final Product.png>)
