...
<figure><img src="../../.gitbook/assets/image (5).png" alt=""><figcaption><p>The Edit menu in Blender.</p></figcaption></figure>
...
<figure><img src="../../.gitbook/assets/image (6).png" alt="" width="495"><figcaption><p>Blender Preferences: Add-ons.</p></figcaption></figure>
...
<figure><img src="../../.gitbook/assets/image (7).png" alt=""><figcaption><p>Enabling the Motive Blender Plugin from the Blender Preferences pane.</p></figcaption></figure>
...
<figure><img src="../../.gitbook/assets/image (9).png" alt=""><figcaption><p>Blender 3D Viewport with the Sidebar collapsed. </p></figcaption></figure>
...
<figure><img src="../../.gitbook/assets/image (10).png" alt="" width="491"><figcaption><p>Motive Application Settings: Streaming Pane. <br>Recommended settings for streaming to Blender.</p></figcaption></figure>
...
<figure><img src="../../.gitbook/assets/image (11).png" alt=""><figcaption><p>The Motive Plugin Panel in Blender.</p></figcaption></figure>
...
<figure><img src="../../.gitbook/assets/image (12).png" alt=""><figcaption><p>IP settings.</p></figcaption></figure>
...
<figure><img src="../../.gitbook/assets/image (14).png" alt=""><figcaption><p>Transmission settings.</p></figcaption></figure>
...
<figure><img src="../../.gitbook/assets/image (15).png" alt=""><figcaption><p>Configuration settings.</p></figcaption></figure>
...
<figure><img src="../../.gitbook/assets/image (17).png" alt=""><figcaption><p>Connection options - while connected.</p></figcaption></figure>
...
* Click the _Start Record_ button <img src="../../.gitbook/assets/image (20).png" alt="" data-size="original"> to begin recording.
* Keyframes will begin moving forward and plotting on the timeline.

<figure><img src="../../.gitbook/assets/image (21).png" alt=""><figcaption><p>Blender timeline with plotted keyframes.</p></figcaption></figure>

* Click the _Stop_ button <img src="../../.gitbook/assets/image (22).png" alt="" data-size="original"> to stop plotting the key frames.
...
* Check the box to toggle on the _Record Frame Range_ function. <img src="../../.gitbook/assets/image (23).png" alt="" data-size="original">
* Click _Select Frame Range,_ input the desired start and end frames to record within, and click OK.

<figure><img src="../../.gitbook/assets/image (24).png" alt=""><figcaption><p>Select Frame Range to record in Blender.</p></figcaption></figure>
...
<figure><img src="../../.gitbook/assets/image (26).png" alt=""><figcaption><p>The Create New Action button.</p></figcaption></figure>
...
<figure><img src="../../.gitbook/assets/image (27).png" alt=""><figcaption><p>Access the Dope Sheet in Blender.</p></figcaption></figure>

* In the _Mode_ dropdown, select _Action Editor_.

<figure><img src="../../.gitbook/assets/image (28).png" alt=""><figcaption><p>Dope Sheet Mode selection.</p></figcaption></figure>

* Use the dropdown list in the upper middle of the Action Editor window to create and edit multiple actions within the same Blender session. If you would like to create new actions this way, click the ![](<../../.gitbook/assets/image (29).png>) button.&#x20;

<figure><img src="../../.gitbook/assets/image (30).png" alt=""><figcaption><p>Available Actions in a Blender session.</p></figcaption></figure>
...
<figure><img src="../../.gitbook/assets/image (32).png" alt=""><figcaption><p>The Info Panel in the <br>Motive Blender plugin.</p></figcaption></figure>
