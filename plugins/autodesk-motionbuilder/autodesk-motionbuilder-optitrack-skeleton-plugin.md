...
![MotionBuilder Skeleton Plugin.](<../../.gitbook/assets/image (735).png>)
...
![Broadcast Frame Data set to true for streaming.](<../../.gitbook/assets/image (141) (1) (1) (1) (1) (1) (1) (5).png>)
...
![Asset Browser tab > Devices view of the plugins.](<../../.gitbook/assets/image (681).png>)

![Navigator](<../../.gitbook/assets/image (662).png>)

### Device Settings

![OptiTrack MotionBuilder Skeleton Plugin settings.](<../../.gitbook/assets/image (689).png>)
...
![Manual binding update MoBu settings.](<../../.gitbook/assets/image (680).png>) ![Manual binding update Motive assets in Assets pane.](<../../.gitbook/assets/image (185).png>)
...
The OptiTrack Skeleton device can record optical data to the current MotionBuilder take. Please refer to the [Autodesk MotionBuilder: OptiTrack Optical Plugin](autodesk-motionbuilder-optitrack-optical-plugin.md) page for steps on how to record from devices into MotionBuilder.
