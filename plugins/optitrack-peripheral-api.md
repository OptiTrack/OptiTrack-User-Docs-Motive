...
1.  Copy the OptiTrackPeripheralExample project and modify the code in the lines where indicated in the sample.Edit the 'REQUIRED' and 'OPTIONAL' sections.​ Changes made in the .cpp files are reflected in the Devices and Properties panes.
    ...
    <figure><img src="../.gitbook/assets/image (2) (8).png" alt=""><figcaption><p>Edit the 'REQUIRED' and 'OPTIONAL' sections. Click image to enlarge.</p></figcaption></figure>

    <figure><img src="../.gitbook/assets/image (1) (5) (1).png" alt=""><figcaption><p>Changes made in the .cpp files are reflected in the Devices and Properties panes.</p></figcaption></figure>
