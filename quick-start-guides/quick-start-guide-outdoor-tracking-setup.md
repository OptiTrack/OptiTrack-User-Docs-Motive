...
![For outdoor capture applications, increase the f-stop setting to decrease the lens aperture size](<../.gitbook/assets/image (520).png>)
...
![Capturing outdoors under shadows](<../.gitbook/assets/image (535).png>)
