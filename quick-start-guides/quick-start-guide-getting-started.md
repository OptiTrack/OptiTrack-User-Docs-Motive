...
<figure><img src="../.gitbook/assets/image (303).png" alt="A clean capture volume with rubber flooring to reduce reflections. "><figcaption></figcaption></figure>
...
<figure><img src="../.gitbook/assets/Network Configuration - standard (1).png" alt="A diagram for a  single switch configuration for a standard camera system. "><figcaption><p>Click image to enlarge.</p></figcaption></figure>
{% endtab %}

{% tab title="Multiple PoE Switch (High camera counts)" %}
<figure><img src="../.gitbook/assets/Network Configuration - Large (1).png" alt="A diagram for a multi-switch configuration for a large camera-count system. "><figcaption><p>Click image to enlarge.</p></figcaption></figure>
...
Use the dropdown menu at the top-left corner to switch between different viewports, or the <img src="../.gitbook/assets/Motive Context Menu (34).png" alt="The View options button from the Motive Viewport." data-size="original"> button at the top-right corner to split the viewport into multiple. If desired, an additional View pane can be open by opening up a Viewer pane under the [View tab](../motive-ui-panes/toolbar-command-bar.md) or by clicking the <img src="../.gitbook/assets/Motive ViewPort Button (3).png" alt="Viewport button from the Motive toolbar." data-size="original"> icon on the main toolbar.
...
1. Set the Calibration Type to _Full_.
