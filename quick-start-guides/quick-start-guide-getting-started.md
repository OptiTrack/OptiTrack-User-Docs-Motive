...
<figure><img src="../.gitbook/assets/image (302).png" alt="A clean capture volume with rubber flooring to reduce reflections. "><figcaption></figcaption></figure>
...
_Ethernet Camera Models: PrimeX series, SlimX series, and VersaX series cameras. Follow the below wiring diagram and connect each of the required system components._

{% tabs %}
{% tab title="Single PoE Switch" %}
<figure><img src="../.gitbook/assets/Network Configuration - standard (2).png" alt="A diagram for a  single switch configuration for a standard camera system. "><figcaption><p>Click image to enlarge.</p></figcaption></figure>
{% endtab %}

{% tab title="Multiple PoE Switch (High camera counts)" %}
<figure><img src="../.gitbook/assets/Network Configuration - Large (2).png" alt="A diagram for a multi-switch configuration for a large camera-count system. "><figcaption><p>Click image to enlarge.</p></figcaption></figure>
...
* **High Camera Counts:** When setting up more than 24 PrimeX, SlimX, or VersaX series cameras, we recommend using a 10 Gigabit uplink switch and connecting it to the host PC via an Ethernet cable that supports a 10 Gigabit transfer rate — Cat6a or above. This will provide greater data bandwidth and reduce the data transfer latency.
{% endtab %}

{% tab title="Switch Power Budget and Camera Power Requirements" %}
<figure><img src="../.gitbook/assets/System Network Structure_PowerBudget_3_2_Version (2).png" alt="An illustration of the Power Budget and Power Consumption requirements for each OptiTrack camera."><figcaption><p>Click image to enlarge.</p></figcaption></figure>
...
* **Connect PoE Switch(es) to the Host PC:** Start by connecting a PoE/PoE+/PoE+++ switch into the host PC via an Ethernet cable. Since the camera system takes up a large amount of data bandwidth, the Ethernet camera network traffic must be separated from the office/local area network.&#x20;

{% hint style="warning" %}
If the computer used for capture is connected to an existing network, you will need to use a second Ethernet port or add-on network card to connect the computer to the camera network. Turn off your computer's firewall for the particular network under Windows Firewall settings.
{% endhint %}

* **Connect the Ethernet Cameras to the PoE Switch(es):** Ethernet cameras connect to the host PC via PoE/PoE+/PoE++ switches using Cat 6 or above, Ethernet cables. See the [Switch Power Budget and Camera Power Requirements tab](quick-start-guide-getting-started.md#switch-power-budget-and-camera-power-requirements) above for camera-specific switch requirements.&#x20;
* **Power the Switches:** The switches must be powered on to supply power to the cameras. To completely shut down the camera system, power off the network switches.
* **Ethernet Cables:** Ethernet cable connection is subject to the limitations of the PoE and Ethernet communications standards, which allows a maximum distance between a camera and its switch of about 100 meters when using Cat 6 cables. Ethernet cable types Cat5e or below are not supported.&#x20;

{% hint style="warning" %}
For best performance, do not connect devices other than the computer to the camera network. Add-on network cards should be installed if additional Ethernet ports are required.
{% endhint %}

* **External Sync:** To connect external devices, use the eSync synchronization hub. Connect the eSync into one of the PoE switches using an Ethernet cable. In a multi-switch setup, plug the eSync into the aggregation switch.

#### **Ethernet Cable Requirements**

There are multiple categories for Ethernet cables, with different specifications for maximum data transmission rate and cable length.&#x20;

* To Connect cameras to the camera switch, use Cat6 (Gigabit) Ethernet cables.&#x20;
* To connect the camera switches to an uplink (aggregation) switch and the uplink switch to the Motive computer, use Cat6a (10 Gigabit) Ethernet cables.
...
<div><figure><img src="../.gitbook/assets/image (497) (1) (1) (1).png" alt="A PrimeX camera mounted to a truss. "><figcaption></figcaption></figure> <figure><img src="../.gitbook/assets/image (636).png" alt="A MoCap actor in a Motion Capture volume setup with a truss and cameras. "><figcaption></figcaption></figure> <figure><img src="../.gitbook/assets/image (278).png" alt="A diagram showing the overlapping fields of view (FoV) of various cameras in a capture volume. "><figcaption></figcaption></figure></div>
...
<div><figure><img src="../.gitbook/assets/image (660).png" alt="A marker displayed on an out-of-focus camera. "><figcaption><p>Out of focus</p></figcaption></figure> <figure><img src="../.gitbook/assets/image (635).png" alt="A marker displayed on a moderately-in-focus camera. "><figcaption><p>Moderately in focus</p></figcaption></figure> <figure><img src="../.gitbook/assets/image (283).png" alt="A marker displayed on a focused camera. "><figcaption><p>In focus</p></figcaption></figure></div>
...
This pane is used in almost all workflows. The Properties pane can be accessed under the View tab in Motive or by clicking the ![Properties pane icon from the Motive toolbar. ](<../.gitbook/assets/Properties Pane button (3).png>) icon from the main toolbar.
...
Use the dropdown menu at the top-left corner to switch between different viewports, or the <img src="../.gitbook/assets/Motive Context Menu (33).png" alt="The View options button from the Motive Viewport." data-size="original"> button at the top-right corner to split the viewport into multiple. If desired, an additional View pane can be open by opening up a Viewer pane under the [View tab](../motive-ui-panes/toolbar-command-bar.md) or by clicking the <img src="../.gitbook/assets/Motive ViewPort Button (2).png" alt="Viewport button from the Motive toolbar." data-size="original"> icon on the main toolbar.
...
![Starting a new calibration.](<../.gitbook/assets/image (615).png>)
...
1. Set the [Calibration Type](../motive/calibration/#calibration-types) to _Full_.
...
![Using Builder pane to define a skeleton](<../.gitbook/assets/image (622).png>)
...
![Tracking data export dialogue window in Motive. CSV export is selected and corresponding export options are listed. Click image to enlarge.](<../.gitbook/assets/image (630).png>)
