...
![The images shows a clear (left) and a less clear(right) image of a marker whose centroid calculation may have been compromised by extraneous bright pixels from the background.](<../.gitbook/assets/image (506) (1).png>)
...
![Capturing multiple unique vantages measure more accurate positions on all of the coordinate axis](<../.gitbook/assets/image (536).png>) ![Cameras placed in a dome arrangement around a cubic meter volume.](<../.gitbook/assets/image (355).png>)
...
![Manfrotto clamp used to mount cameras.](<../.gitbook/assets/image (523).png>) ![Camera mounted onto a truss structure using the clamp.](<../.gitbook/assets/image (528).png>)

## Focus and Aiming

![Grayscale images of a marker captured with varying camera focus](<../.gitbook/assets/image (537).png>)
...
![Factory calibrated wand length indicated on the bottom label of the CMW-125](<../.gitbook/assets/image (538).png>) ![Define the precise wand length in the Calibration pane](<../.gitbook/assets/image (490).png>)
...
![Two markers are placed too close to each other and their reflections are getting merged.](<../.gitbook/assets/image (527).png>)
...
![Temperature of the processor board and the ringlight board displayed in the camera info.](<../.gitbook/assets/image (521).png>)
...
![Calculated 2D centroid location from the camera's perspective (thicker white line) and centroid location derived from reconstructed marker position (thinner yellow line).](<../.gitbook/assets/image (512).png>)
...
![Monitoring convergence of the tracked rays.](<../.gitbook/assets/image (516).png>)
