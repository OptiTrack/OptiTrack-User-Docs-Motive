...
* Active tracking is supported only with the Ethernet camera system (Prime series or Slim 13E cameras). For instructions on how to set up a camera system see: [Hardware Setup](../hardware/).
...
![BaseStation setup.](<../.gitbook/assets/image (732).png>) ![Assembled Tags.](<../.gitbook/assets/image (219) (1) (1) (1) (1) (2) (1).png>)
...
![Puck initializing. Top-left: Orange.](<../.gitbook/assets/image (144).png>) ![Connected to base station and receiving sync packets.](<../.gitbook/assets/image (715).png>)
...
With a BaseStation and Active Markers communicating on the same RF, active markers will be reconstructed and tracked in Motive automatically. From the unique illumination patterns, each active marker gets labeled individually, and a unique marker ID gets assigned to the corresponding reconstruction in Motive. These IDs can be monitored in the [Live-reconstruction mode or in the 2D Mode](../motive/reconstruction-and-2d-mode.md). To check the marker IDs of respective reconstructions, enable the **Marker Labels** option under the visual aids (<img src="../.gitbook/assets/image (129).png" alt="" data-size="line">), and the IDs of selected markers will be displayed. The marker IDs assigned to active marker reconstructions are unique, and it can be used to point to a specific marker within many reconstructions in the scene.

![Unique marker IDs assigned to the active markers.](<../.gitbook/assets/image (708).png>)
