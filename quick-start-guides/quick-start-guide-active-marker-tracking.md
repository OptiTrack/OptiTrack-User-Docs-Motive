...
metaLinks:
  alternates:
    - >-
      https://app.gitbook.com/s/GaZwzcsVav6zPBRZpapU/quick-start-guides/quick-start-guide-active-marker-tracking
---
...
![BaseStation setup.](<../.gitbook/assets/image (1280).png>) ![Assembled Tags.](<../.gitbook/assets/image (1326).png>)
