...
![Accessing microphone properties from the Sound settings.](<../.gitbook/assets/image (378).png>) ![Configuring microphone device format.](<../.gitbook/assets/image (302) (1) (1).png>)
...
![Exporting recorded audio in Motive.](<../.gitbook/assets/image (448).png>)
