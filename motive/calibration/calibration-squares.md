...
| --------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| ![](<../../.gitbook/assets/image (710).png>)  | <p></p><p>CS-100: <br><br>Used to define a ground plane in a small, precise motion capture volumes.</p><ul><li>Long arm: Positive z</li><li>Short arm: Positive x</li><li>Vertical offset: 11.5 mm</li><li>Marker size: 9.5 mm (diameter)</li></ul>                                                                 |
