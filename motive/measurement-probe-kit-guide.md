...
![Measurement probe.](<../.gitbook/assets/image (354).png>) ![Calibration block with slots for the probe tip.](<../.gitbook/assets/image (364).png>)
...
![Creating measurement probe in Motive](<../.gitbook/assets/image (318).png>)
...
![Sampling 3D points using the measurement probe.](<../.gitbook/assets/image (329).png>)

![Probe pane displaying live 3D position of the probe tip, and position, distance, and angle of the previously collected points.](<../.gitbook/assets/image (382).png>)
...
![Exporting sampled points from the Probe pane.](<../.gitbook/assets/image (305).png>)
