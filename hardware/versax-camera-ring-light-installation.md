...
<div><figure><img src="../.gitbook/assets/VersaX with No Ring Light Attached.jpg" alt="A VersaX 41 camera. " width="375"><figcaption><p>A VersaX Camera prior to attaching the ring light. </p></figcaption></figure> <figure><img src="../.gitbook/assets/VersaX Ring Light.jpg" alt="The Ring Light for the VersaX 41 camera." width="375"><figcaption><p>A ring light for a VersaX camera.</p></figcaption></figure></div>
...
<div><figure><img src="../.gitbook/assets/VersaX Camera plug for Ring Light.jpg" alt="The Ring Light connector on the VersaX Camera."><figcaption><p>Ring Light Connector on the VersaX Camera.</p></figcaption></figure> <figure><img src="../.gitbook/assets/VersaX Ring Light Connector.jpg" alt="The Ring Light connector on the Ring Light. "><figcaption><p>The Ring Light Connector on the Ring Light.</p></figcaption></figure></div>

3 posts lock the ring light into the corresponding post holes in the VersaX camera:

<div><figure><img src="../.gitbook/assets/VersaX Camera Ring Light screw hole.jpg" alt="Post hole for securing the Ring Light."><figcaption><p>Post hole for securing the Ring Light.</p></figcaption></figure> <figure><img src="../.gitbook/assets/VersaX Ring Light locking posts.jpg" alt="Lock/unlock guide on the Ring Light post. "><figcaption><p>Lock/unlock guide on the Ring Light post. </p></figcaption></figure></div>
...
<figure><img src="../.gitbook/assets/Placing Camera on Ring Light.jpg" alt="A photo of a hand setting the VersaX camera onto the Ring Light." width="375"><figcaption><p>Setting the VersaX camera onto the Ring Light.</p></figcaption></figure>
...
<figure><img src="../.gitbook/assets/Locking Camera on Ring Light step 1.jpg" alt="A photo of a hand inserting the locking tool into the locking mechanism on the VersaX ring light." width="375"><figcaption><p>Inserting the Locking Tool into a Post. </p></figcaption></figure>
...
<figure><img src="../.gitbook/assets/Locking Camera on Ring Light step 3 CROPPED.jpg" alt="A photo of hands Locking a Post in Place with the Locking Tool." width="375"><figcaption><p>Locking a Post in Place with the Locking Tool.</p></figcaption></figure>
