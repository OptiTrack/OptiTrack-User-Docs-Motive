...
3. Under _Settings_ section, click _Change high DPI settings_. This will bring up the properties window.
...
6. Click _OK_ to apply. This will override any incorrect scaling behavior when using Motive on high DPI displays.
