...
Please note that the OptiHub2 is not designed for _precise_ synchronization with external devices. It is used to provide only a _rough_ synchronization to a trigger event on the input/output signal. Using an OptiHub2, there will be some amount of time delay between the trigger events and the desired actions, and for this reason, the OptiHub2 is not suitable for the precisely synchronizing to an external device. To accomplish such synchronization, it is recommended to use the [eSync 2](external-device-sync-guide-esync-2.md) instead along with an Ethernet camera system.
{% endhint %}
...
![OptiSync](<../../.gitbook/assets/image (205).png>) ![Wired Sync](<../../.gitbook/assets/image (737).png>)
...
![](<../../.gitbook/assets/image (1036) (1) (1) (1) (1) (2) (1).png>)
...
![Trigger to exposure delay in Flex 13 cameras.](<../../.gitbook/assets/image (249).png>)
...
![Using the BNC splitter for connecting additional child devices.](<../../.gitbook/assets/image (251).png>)
...
![Recording Gate output signal.](<../../.gitbook/assets/image (215).png>)
