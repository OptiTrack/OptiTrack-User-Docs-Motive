...
![eSync2 properties listed under the Properties pane.](<../.gitbook/assets/image (633).png>)
...
* Tracking bars (Duo 3 or Trio 3) have sync settings that are same as the OptiHub2. Please refer to the above OptiHub2 properties page for references its sync settings.
