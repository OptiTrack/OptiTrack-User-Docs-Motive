...
This Marker Set can be used with Active Tags in conjunction with the Core Marker Set.

<div><figure><img src="../../.gitbook/assets/image (701).png" alt=""><figcaption></figcaption></figure> <figure><img src="../../.gitbook/assets/image (1421).png" alt=""><figcaption></figcaption></figure></div>

<figure><img src="../../.gitbook/assets/image (961).png" alt=""><figcaption></figcaption></figure>

### Full Body Markers

The Baseline + Active Fingers Marker Set has the same placement for the body as the [Baseline Marker Set](../full-body/baseline-41.md), however, there are additional Active markers on the wrist, hand, and fingers.

### Hand + Finger Markers

The Active Finger Markerset uses a total of 10 markers per hand, 8 active with 2 passive markers attached at the wrist.
...
| <p>LThumb<br>RThumb</p>       | Finger          | Place the marker on the thumb on the 1st metacarpophalangeal joint                                                                                                                                         |
| <p>LFingers<br>RFingers</p>   | Finger          | Place markers on the tips of each finger and thumb                                                                                                                                                         |
