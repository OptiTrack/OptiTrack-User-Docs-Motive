...
Please see the page[ Information for Assembling the Active Tags](../active-components-hardware/information-for-assembling-the-active-tags.md) for more information. &#x20;
...
For product specifications and other information about the Puck, please see the page [Active Puck](../active-components-hardware/active-puck.md).&#x20;
...
<figure><img src="../../.gitbook/assets/image (34).png" alt="" width="227"><figcaption><p>CinePuck.</p></figcaption></figure>
...
For product specifications and other information about the CinePuck, please see the page [CinePuck](../active-components-hardware/cinepuck.md).&#x20;
...
* The number of Active Devices that can attach to a a single BaseStation is determined by the system frame rate and the divisor applied to the BaseStation. The [BaseStation Load Capacity table](../active-components-hardware/basestation.md#basestation-load-capacity) on the [BaseStation ](../active-components-hardware/basestation.md)page shows the IMU maximum for common frame rates and divisors.
...
![BaseStation Setup](<../../.gitbook/assets/image (573).png>)
...
* For more information, please read the [Active Puck](../active-components-hardware/active-puck.md) page.
...
1. Click the <img src="../../.gitbook/assets/image (64).png" alt="" data-size="line"> in the 3D Viewport to open the Visual Aids menu.&#x20;
