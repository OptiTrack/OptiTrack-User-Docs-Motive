...
![The eSync 2. For more specifications go to the OptiTrack website.](<../../.gitbook/assets/image (1110) (1) (1) (1) (1) (1) (1) (6).png>)

![AMTI Force Plate Setup example with eSync 2. Click image to enlarge.](<../../.gitbook/assets/image (250).png>)
...
![Selecting synchronization input source.](<../../.gitbook/assets/image (1006).png>)
...
![Sample sync source setup resulting in a final system framerate of 240 Hz.](<../../.gitbook/assets/image (280).png>)
...
![Applying sync offset for aligning exposure timing.](<../../.gitbook/assets/image (272).png>)
...
![A BNC splitter can be used for connecting additional child devices if needed.](<../../.gitbook/assets/image (267).png>)
...
![Exposure Time output signal.](<../../.gitbook/assets/image (292).png>)

![Gated Exposure Time output signal.](<../../.gitbook/assets/image (704).png>)
...
![Recording Gate output signal.](<../../.gitbook/assets/image (275).png>)

![Recording Start/End Pulse output signal.](<../../.gitbook/assets/image (230).png>)
...
![Gated internal clock output.](<../../.gitbook/assets/image (739).png>)
...
![eSync 2 clock signal internal sync and output comparison.](<../../.gitbook/assets/image (245).png>)
