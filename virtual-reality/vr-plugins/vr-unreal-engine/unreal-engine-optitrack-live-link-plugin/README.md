...
![OptiTrack - Live Link plugin. Make sure the plugins are placed in the plugins folder either in the project or engine directory.](<../../../../.gitbook/assets/image (95).png>)

![Built-In Live Link plugin.](<../../../../.gitbook/assets/image (81).png>)

**4. \[UE] Open the LiveLink pane**

Open the LiveLink pane from _Window → Virtual Production → Live Link_ in the toolbar.

![Live Link pane in UE5.](<../../../../.gitbook/assets/image (87).png>)

![Live Link pane in UE5.](<../../../../.gitbook/assets/image (63).png>)
...
![Creating OptiTrack source with client streaming settings.](<../../../../.gitbook/assets/image (60).png>)
...
![Connected to the rigid body data stream.](<../../../../.gitbook/assets/image (11) (1) (1).png>)
...
![Camera actor listed under the Place Actors pane.](<../../../../.gitbook/assets/image (2) (1) (1) (1) (1).png>) ![Actor mobility set to movable.](<../../../../.gitbook/assets/image (79).png>)
...
![Live Link Controller component needs be added.](<../../../../.gitbook/assets/image (38).png>)
...
![The target rigid body selected under Live Link Controller component properties.](<../../../../.gitbook/assets/image (10) (1) (1) (1).png>)
...
![Select the timecode provider under project settings.](<../../../../.gitbook/assets/image (39).png>)
...
![Enable timecode provider setting in the plugin.](<../../../../.gitbook/assets/image (28).png>)
...
![Timecode shown in the Take Recorder pane.](<../../../../.gitbook/assets/image (66).png>)
...
![New animation blueprint.](<../../../../.gitbook/assets/image (62).png>)
...
![Rename blueprint.](<../../../../.gitbook/assets/image (90).png>)
...
![Connect to pose, then choose name.](<../../../../.gitbook/assets/image (23) (1) (1) (1).png>)

Change the "Retarget Asset" property in the Details pane of the blueprint editor to "OptiTrackLiveLinkRetarget"

![Retargeting option.](<../../../../.gitbook/assets/image (43).png>)
...
![Component to animate Skeleton.](<../../../../.gitbook/assets/image (83).png>)
...
<figure><img src="../../../../.gitbook/assets/image (21).png" alt=""><figcaption><p>Select OptiTrack Live Link Display from Quick Add</p></figcaption></figure>

<figure><img src="../../../../.gitbook/assets/image (24).png" alt=""><figcaption><p>Default green debug skeleton from OptiTrack Live Link Display</p></figcaption></figure>
...
![Options for retargeting to different names. Click image to enlarge.](<../../../../.gitbook/assets/image (31).png>)
...
![Component to animate Skeleton.](<../../../../.gitbook/assets/image (72).png>)
...
![MetaHuman Skeletal Mesh default window view.](<../../../../.gitbook/assets/image (56).png>)

![Blueprint tab view.](<../../../../.gitbook/assets/image (33).png>)
...
![Animgraph before.](<../../../../.gitbook/assets/image (25) (1) (1).png>)

![Animgraph after.](<../../../../.gitbook/assets/image (69).png>)
...
![Retarget Asset from Details Tab](<../../../../.gitbook/assets/image (44).png>)
...
![Component to animate Skeleton.](<../../../../.gitbook/assets/image (57).png>)
...
![Component to animate Skeleton.](<../../../../.gitbook/assets/image (13) (1) (1).png>)
...
![Creating a preset from Live Link panel. Select Save As Preset.](<../../../../.gitbook/assets/image (74).png>)

![Assigning the preset in the Project Settings.](<../../../../.gitbook/assets/image (64).png>)

![Playing a scene in standalone game mode.](<../../../../.gitbook/assets/image (14) (1).png>)
