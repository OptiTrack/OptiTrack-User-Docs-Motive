...
1. Download the [plugin ZIP file](https://optitrack.com/downloads/plugins.html|).
...
See: [OptiTrack Unreal Engine](../../../plugins/optitrack-unreal-engine-plugin/) page for more instructions on setting up the client origin.
