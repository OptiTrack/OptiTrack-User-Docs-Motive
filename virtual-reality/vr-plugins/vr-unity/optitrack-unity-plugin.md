...
* The HTC VIVE, VIVE Pro, VIVE Pro 2, Valve Index, and HP Reverb HMDs can be integrated through the [OptiTrack OpenVR Driver](../vr-openvr/optitrack-openvr-driver.md).
{% endhint %}
...
![Data Streaming settings in Motive.](<../../../.gitbook/assets/image (1182).png>)
...
OptiTrack motion capture systems can be used to track head mounted displays (HMD) and integrate the tracking data into Unity for unique VR applications. For instructions on integrating HMD tracking data into Unreal Engine, please refer to the corresponding page [Unity: HMD Setup](../../../plugins/optitrack-unity-plugin/unity-hmd-setup.md).
