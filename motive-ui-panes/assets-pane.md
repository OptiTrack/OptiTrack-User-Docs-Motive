...
Re-calibrates an existing Skeleton. This feature is essentially same as re-creating a Skeleton using the same Skeleton Marker Set. See [Skeleton Tracking](../motive/skeleton-tracking.md) page for more information on using the Skeleton template XML files.
