...
metaLinks:
  alternates:
    - >-
      https://app.gitbook.com/s/GaZwzcsVav6zPBRZpapU/motive-ui-panes/settings/settings-mouse-and-keyboard
---
...
![Mouse actions configured in the application settings panel.](<../../.gitbook/assets/image (263).png>)
...
![Mouse profile presets.](<../../.gitbook/assets/image (1434).png>)

## Keyboard

#### **Customizing Hotkeys**

The Keyboard tab under the application settings allows you to assign specific hotkey actions to make Motive easier to use. List of default key actions can be found in the following page also: [Motive Hotkeys](../../motive/motive-hotkeys.md)

![Keyboard hotkeys configured in the application settings panel.](<../../.gitbook/assets/image (326).png>)
...
![Keyboard hotkey presets in the application settings panel.](<../../.gitbook/assets/image (572).png>)
