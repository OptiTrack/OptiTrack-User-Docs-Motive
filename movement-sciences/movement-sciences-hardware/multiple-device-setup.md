...
![Mocap system + Force Plate + NIDAQ + Recoding Trigger setup. Click image to enlarge.](<../../.gitbook/assets/image (590).png>)
...
![Peripheral Device module installation.](<../../.gitbook/assets/image (1146).png>) ![NI-DAQmx 15.1.1 installation.](<../../.gitbook/assets/DAQmxInstall (1).gif>)
