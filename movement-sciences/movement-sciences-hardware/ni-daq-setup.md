...
![Wiring diagram for screw terminal NI-DAQ devices. The analog input channels in this configuration should use RSE terminal type.](<../../.gitbook/assets/image (10) (3).png>)

**BNC Terminal Cabling**

![Wiring diagram for BNC terminal NI-DAQ devices. The analog input channels in this configuration should use Diff terminal type.](<../../.gitbook/assets/image (4) (1) (2) (1).png>)
...
![Wiring diagram for screw terminal NI-DAQ devices. The analog input channels in this configuration should use RSE terminal type.](<../../.gitbook/assets/image (3) (1) (2).png>)
...
![Connected NI-DAQ device detected and listed under Devices Pane in Motive.](<../../.gitbook/assets/image (745).png>)
...
![Recorded signal from the NI-DAQ channel displayed on the Graph pane in Motive.](<../../.gitbook/assets/image (1111).png>)

![Creating graph layout for live-scoping analog channels.](<../../.gitbook/assets/image (810).png>)
...
![Properties for the NI-DAQ device selected in Devices pane gets displayed in the Properties pane.](<../../.gitbook/assets/image (1078).png>)
...
![NI-DAQ device channel properties displayed in the Devices pane.](<../../.gitbook/assets/image (823).png>)
...
![Quick configuration of the eSync 2.](<../../.gitbook/assets/image (1059).png>)

![Quick configuration of the NI-DAQ.](<../../.gitbook/assets/image (827).png>)
{% endtab %}
...
![Properties of the eSync 2 for synchronization with NI-DAQ devices through the clock signal.](<../../.gitbook/assets/image (777).png>)

![NI-DAQ Properties for synchronizing to the clock signal from the eSync 2.](<../../.gitbook/assets/image (837).png>)
{% endtab %}
...
![Properties of the eSync 2 for synchronization with NI-DAQ devices through the recording gate signal.](<../../.gitbook/assets/image (776).png>)

![NI-DAQ Properties for synchronizing against the recording trigger signal from the eSync 2.](<../../.gitbook/assets/image (791).png>)
{% endtab %}
{% endtabs %}
...
![A recorded NI-DAQ device and its channels displayed under the Devices pane.](<../../.gitbook/assets/image (801).png>)
...
![C3D export setting for applications using z-up right-handed coordinate systems.](<../../.gitbook/assets/image (1055) (1) (1) (1) (1) (1) (1) (8).png>)
