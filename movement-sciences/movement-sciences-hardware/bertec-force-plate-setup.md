...
Configure force plate sampling rate from [Devices pane](../../motive-ui-panes/devices-pane.md).
...
* Starting with Motive 3.0, reference clock synchronization while in Live mode is supported.
{% endhint %}
...
![Click image to enlarge.](<../../.gitbook/assets/image (603).png>)
{% endtab %}
...
![Click image to enlarge.](<../../.gitbook/assets/image (599).png>)

![Zero cable from the amplifier](<../../.gitbook/assets/image (1140).png>)
{% endtab %}
{% endtabs %}
...
![Motive force plate representation in Perspective view.](<../../.gitbook/assets/image (1086).png>) ![Status Log pane in Motive.](<../../.gitbook/assets/image (1078).png>)
...
![Bertec force plate with CS-400 aligned properly.](<../../.gitbook/assets/image (1279).png>) ![Calibrated force plate position and orientation. X and Y axis is shown.](<../../.gitbook/assets/image (1131).png>)
...
![Set the force plate data to zero for more accurate data.](<../../.gitbook/assets/image (1101).png>)
...
![Applying Biomech preset settings.](<../../.gitbook/assets/image (1346).png>)
